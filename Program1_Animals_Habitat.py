...
#     habitat = animals[number]
#     print(habitat)
#     print("----For exiting the program type 'exit'----")
#     print("Which habitat # do you need? > ")
#     number = int(input())
# if number == input("exit"):
#     print("See you")
#     exit()
while True:
    habitat_no = input("Which habitat # do you need?")
    if habitat_no != "exit":
        habitat = int(habitat_no)
        while habitat >= 0 and habitat <= 5:
            print(animals[habitat])
            break
        else:
            print("You typed a wrong number! Try again choosing a number from 0 to 5")
    else:
        print("See you!")
        break
